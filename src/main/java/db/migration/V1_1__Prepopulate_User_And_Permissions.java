...
public class V1_1__Prepopulate_User_And_Permissions extends BaseJavaMigration{
        ...
        public void migrate(Context context) throws Exception {
            ...
            try (PreparedStatement stmt = connection.prepareStatement(
                ...
                stmt.setString(1, "READ_ROLE"); stmt.executeUpdate();
                stmt.setString(1, "WRITE_ROLE"); stmt.executeUpdate();
                stmt.setString(1, "DELETE_ROLE"); stmt.executeUpdate();

                stmt.setString(1, "READ_PERMISSION"); stmt.executeUpdate();
